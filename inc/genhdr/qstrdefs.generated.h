...
QDEF(MP_QSTR_calliopemini, (const byte*)"\x37\x0c" "calliopemini")
...
QDEF(MP_QSTR_pin_MIC, (const byte*)"\x6a\x07" "pin_MIC")
QDEF(MP_QSTR_pin_M_IN1, (const byte*)"\x09\x09" "pin_M_IN1")
QDEF(MP_QSTR_pin_M_IN2, (const byte*)"\x0a\x09" "pin_M_IN2")
QDEF(MP_QSTR_pin_M_SLEEP, (const byte*)"\xd0\x0b" "pin_M_SLEEP")
QDEF(MP_QSTR_pin_RGB, (const byte*)"\x3a\x07" "pin_RGB")
QDEF(MP_QSTR_pin_btnA, (const byte*)"\xd4\x08" "pin_btnA")
QDEF(MP_QSTR_pin_btnB, (const byte*)"\xd7\x08" "pin_btnB")
